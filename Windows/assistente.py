...
if not os.listdir(imagem_pasta):
    ...
    shutil.copy("imagens_app/alerta_vermelho.png", imagem_pasta)
    shutil.copy("imagens_app/alerta_verde.png", imagem_pasta)
    shutil.copy("imagens_app/alerta_amarelo.png", imagem_pasta)
    shutil.copy("imagens_app/alerta_rosa.png", imagem_pasta)
    shutil.copy("imagens_app/alerta_preto.png", imagem_pasta)
    shutil.copy("imagens_app/alerta_branco.png", imagem_pasta)
    shutil.copy("imagens_app/alerta_azulmn.png", imagem_pasta)
    shutil.copy("imagens_app/alerta_marrom.png", imagem_pasta)
    shutil.copy("imagens_app/alerta_azullogus.png", imagem_pasta)
    shutil.copy("imagens_app/logo.ico", imagem_pasta)
