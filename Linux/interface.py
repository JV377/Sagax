...
class janela_inic(CTk):
    def __init__(self):
        ...
        icone = os.path.join(imagem_pasta, "Sponte.png")
        self.iconphoto(True, PhotoImage(file=icone))
        #imagens_pasta("imagens/logo.ico")

        self.configure(fg_color="#105ba0")
        self.fonte_titulo = CTkFont(family="Helvetica", size=34, weight="bold")
        self.fonte_inic   = CTkFont(family="Helvetica", size=13)
        self.fonte_dots   = CTkFont(family="Helvetica", size=18, weight="bold")
        self.label_logus = CTkLabel(self, text="Sponte Study", text_color="#ffffff", font=self.fonte_titulo, fg_color="#105ba0")
        self.label_logus.pack(pady=(44, 4))
        self.inicializacao = CTkLabel(self, text="Inicializando...", text_color="#a8c8e8", font=self.fonte_inic, fg_color="#105ba0")
        self.inicializacao.pack(pady=2)
        self._dots_frame = CTkFrame(self, fg_color="#105ba0")
        self._dots_frame.pack(pady=12)
        self._d1 = CTkLabel(self._dots_frame, text="●", text_color="white", font=self.fonte_dots, fg_color="#105ba0", width=16)
        self._d2 = CTkLabel(self._dots_frame, text="●", text_color="white", font=self.fonte_dots, fg_color="#105ba0", width=16)
        self._d3 = CTkLabel(self._dots_frame, text="●", text_color="white", font=self.fonte_dots, fg_color="#105ba0", width=16)
        self._d1.pack(side="left", padx=4)
        self._d2.pack(side="left", padx=4)
        self._d3.pack(side="left", padx=4)
        self._dot_step = 0
        self._animar_dots()
        self.bem_vindo = CTkLabel(self, text="Boas Vindas", text_color="#ffffff", font=self.fonte_titulo, fg_color="#105ba0")

        def muda_texto():
            self.inicializacao.destroy()
            self._dots_frame.destroy()
        def boas_vindas():
            self.bem_vindo.pack(pady=30)
        def fechar():
            self.destroy()
    ...
    def _animar_dots(self):
        dim = "#4a7aaa"
        seq = [("#ffffff", dim, dim), (dim, "#ffffff", dim), (dim, dim, "#ffffff"), ("#ffffff","#ffffff","#ffffff")]
        c = seq[self._dot_step % 4]
        try:
            self._d1.configure(text_color=c[0])
            self._d2.configure(text_color=c[1])
            self._d3.configure(text_color=c[2])
            self._dot_step += 1
            self.after(300, self._animar_dots)
        except Exception:
            pass
...
class janela_preench(CTk):
    def __init__(self):
        ...
        self.fonte_conhecer = CTkFont(family="Helvetica", size=22, weight="bold")
        self.fonte_erros = CTkFont(family="Helvetica", size=13, weight="bold")
        self.fonte_sub_header = CTkFont(family="Helvetica", size=12)

        # header azul
        self._header = CTkFrame(self, fg_color="#105ba0", corner_radius=0, height=82)
        self._header.pack(fill="x")
        self._header.pack_propagate(False)
        CTkLabel(self._header, text="Conhecendo-te", font=self.fonte_conhecer,
                 text_color="#ffffff", fg_color="#105ba0").place(x=30, y=14)
        CTkLabel(self._header, text="Vamos personalizar sua experiência de estudos",
                 font=self.fonte_sub_header, text_color="#a8c8e8", fg_color="#105ba0").place(x=30, y=50)

        self.titulo = CTkLabel(self, text="", fg_color="#f7f9fc")  # placeholder mantido pra não quebrar refs
        ...
        self.nome_caixa = CTkEntry(self, width=170, placeholder_text="Digite seu nome...", placeholder_text_color="#7a99b8", corner_radius=9, border_width=1, border_color="#c8d8ec", fg_color="#ffffff", text_color="#0e2a42")
        self.idade_caixa = CTkEntry(self, width=170, placeholder_text="Digite sua idade...", placeholder_text_color="#7a99b8", corner_radius=9, border_width=1, border_color="#c8d8ec", fg_color="#ffffff", text_color="#0e2a42")
        self.data_nasci = CTkEntry(self, width=180, placeholder_text="Digite sua data de niver...", placeholder_text_color="#7a99b8", corner_radius=9, border_width=1, border_color="#c8d8ec", fg_color="#ffffff", text_color="#0e2a42")
        self.data_nasci.bind("<Enter>", inserirbarra)
        self.meunome_caixa = CTkEntry(self, width=178, placeholder_text="Como deseja me chamar?", placeholder_text_color="#7a99b8", corner_radius=9, border_width=1, border_color="#c8d8ec", fg_color="#ffffff", text_color="#0e2a42")
        self.botao_enviar = CTkButton(self, text="Começar", width=452, height=42, cursor="hand2", corner_radius=9, border_width=0, fg_color="#105ba0", hover_color="#0c3f70", text_color="white", font=CTkFont(family="Helvetica", size=14, weight="bold"), command=enviando)
...
class janela_principal(CTk):
    def __init__(self):
        ...
        leitura = CTkImage(Image.open(os.path.join(imagem_pasta, caminho_leitura)), size=(17, 17))

        #Definindo a fonte da hora
        fonte_hora = CTkFont(family="Helvetica", size=38, weight="bold")
        #Fonte da data
        fonte_data = CTkFont(family="Helvetica", size=16, weight="bold")
        #Fonte de erros internos
        fonte_erros_inter = CTkFont(family="Helvetica", size=13, weight="bold")
        #Fonte do label ajuda
        fonte_ajuda = CTkFont(family="Helvetica", size=13)
        #Fonte para negritos
        fonte_negrito = CTkFont(family="Helvetica", size=13, weight="bold")
        #Fontes das anotações
        fonte_8 = CTkFont(family="Helvetica", size=8)
        fonte_10 = CTkFont(family="Helvetica", size=10)
        fonte_12 = CTkFont(family="Helvetica", size=12)
        fonte_14 = CTkFont(family="Helvetica", size=14)
        fonte_16 = CTkFont(family="Helvetica", size=16)
        fonte_18 = CTkFont(family="Helvetica", size=18)
        fonte_20 = CTkFont(family="Helvetica", size=20)
        fonte_22 = CTkFont(family="Helvetica", size=22)
        ...
        def explica_config_fora(evento):
            ...
            self.label_ajuda.place(x=20, y=200)
        ...
        def saudacao_gui():
            fala_dia = verifica_fala_dia()
            fala_tarde = verifica_fala_tarde()
            fala_noite = verifica_fala_noite()
            hora_agora_fala = hora_gui
            if pev == "Ativa" and fala_dia == False and hora_agora_fala >= 00 and hora_agora_fala < 13:
                self.thread_ola_central = threading.Thread(target=bom_dia, daemon=True)
                self.thread_ola_central.start()
                faloud = True
                hora_da_fala_dia(faloud)
            elif pev == "Ativa" and fala_tarde == False and hora_agora_fala >= 13 and hora_agora_fala < 18:
                self.thread_ola_central = threading.Thread(target=boa_tarde, daemon=True)
                self.thread_ola_central.start()
                falout = True
                hora_da_fala_tarde(falout)
            elif pev == "Ativa" and fala_noite == False and hora_agora_fala >= 18 and hora_agora_fala < 00:
                self.thread_ola_central = threading.Thread(target=boa_noite, daemon=True)
                self.thread_ola_central.start()
                faloun = True
        ...
        def escolha_comecar_b(escolha):
            if escolha == "Nota":
                ...
                self.frame_notas.place_forget() 
                self.frame_anota = CTkFrame(self, width=400, height=260, fg_color=pg)
                self.frame_anota.pack(pady=20)
                self.botao_voltar_anotas = CTkButton(self.frame_anota, text="Voltar", fg_color=cls, width=4, height=22,border_width=0, corner_radius=9, cursor="hand2", command=voltar_anota_b, hover_color=ch)
                self.botao_voltar_anotas.place(x=330, y=1)
                self.tipo_nota = CTkOptionMenu(self.frame_anota, width=90, cursor="hand2", values=["Português", "Matemática", "História", "Geografia", "Ciências", "Inglês", "Outros Estudos"], fg_color=cls, height=26, corner_radius=9, button_color=cls, text_color=ctb, button_hover_color=ch, dropdown_fg_color=cls, dropdown_text_color=ctb, dropdown_hover_color=ch, command=muda_titulo_b)
                self.tipo_nota.place(x=240, y=50)
                self.tamanho_fonte = CTkOptionMenu(self.frame_anota, width=90, cursor="hand2", values=["8","10", "12", "14", "16", "18", "20", "22"], fg_color=cls, height=26, corner_radius=9, button_color=cls, text_color=ctb, button_hover_color=ch, dropdown_fg_color=cls, dropdown_text_color=ctb, dropdown_hover_color=ch, command=fonte_tamanho_b)
                self.tamanho_fonte.place(x=225, y=90)
                self.tamanho_fonte.set("Tamanho Da Fonte...")
                self.tipo_nota.set("Tipo De Notas...")
                self.titulo = CTkEntry(self.frame_anota, width=212, placeholder_text="Título...", corner_radius=9, border_color=cbp, placeholder_text_color=cbp, text_color=ctt, fg_color=cf)
                self.titulo.place(x=10, y=50)
                self.texto = CTkTextbox(self.frame_anota, width=210, height=170, border_width=1, border_color=cbp, corner_radius=9, text_color=ctt, fg_color=cf)
                self.texto.place(x=10, y=90)
                ...
                self.botao_salvar = CTkButton(self.frame_anota, text="Salvar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=salvar_texto_b, hover_color=ch)
                self.botao_salvar.place(x=230, y=235)
                self.botao_leitura_b = CTkButton(self.frame_anota, text="Ler", image=leitura, fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=ler_b, hover_color=ch)
                self.botao_leitura_b.place(x=304, y=235)
            elif escolha == "Código":
                def voltar_code():
                ...
                self.botao_voltar_codigo = CTkButton(self.frame_codigo, text="Voltar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=voltar_code, hover_color=ch)
                self.botao_voltar_codigo.place(x=404, y=1)
                self.fonte_tamanho_codigo = CTkOptionMenu(self.frame_codigo, width=90, cursor="hand2", values=["8","10", "12", "14", "16", "18", "20", "22"], fg_color=cls, height=26, corner_radius=9, button_color=cls, text_color=ctb, button_hover_color=ch, dropdown_fg_color=cls, dropdown_text_color=ctb, dropdown_hover_color=ch, command=fonte_tamanho_codigo)
                self.fonte_tamanho_codigo.place(x=4, y=25)
                self.fonte_tamanho_codigo.set("Tamanho Da Fonte...")
                self.texto_codigo = ccb.CTkCodeBox(self.frame_codigo, width=227, height=160, theme="arduino", language="python",fg_color=cf, border_width=1, border_color=cbp, corner_radius=9, numbering_color=cbp, menu=False)
                ...
                self.tema = CTkOptionMenu(self.frame_codigo, width=90, cursor="hand2", values=["Arduino","Abap", "Autumn", "Borland", "Colorful", "Default", "Dracula", "Emacs", "Friendly", "Fruity", "Igor", "Inkpot"], fg_color=cls, height=26, corner_radius=9, button_color=cls, text_color=ctb, button_hover_color=ch, dropdown_fg_color=cls, dropdown_text_color=ctb, dropdown_hover_color=ch, command=tema)
                self.tema.place(x=4, y=60)
                self.tema.set("Seu Tema Favorito...")
                self.linguagem = CTkOptionMenu(self.frame_codigo, width=90, cursor="hand2", values=["Python", "JavaScript", "Lua", "Rust", "CSS", "HTML", "Java", "C++", "PHP", "C#", "Zig"], fg_color=cls, height=26, corner_radius=9, button_color=cls, text_color=ctb, button_hover_color=ch, dropdown_fg_color=cls, dropdown_text_color=ctb, dropdown_hover_color=ch, command=lang)
                ...
                self.fonte_tamanho_descricao.set("Tamanho Da Fonte...")
                self.titulo_codigo = CTkEntry(self.frame_codigo, width=212, border_width=2, border_color=cbp, corner_radius=9, text_color=ctt, fg_color=cf, placeholder_text="Título...", placeholder_text_color=cbp)
                self.titulo_codigo.place(x=258, y=70)
                self.titulo_codigo.bind("<Enter>", muda_titulo_codigo)
                self.descricao = CTkTextbox(self.frame_codigo, width=212, height=90, border_width=1, border_color=cbp, corner_radius=9, text_color=ctt, fg_color=cf)
                ...
                self.botao_salvar = CTkButton(self.frame_codigo, text="Salvar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=salvar_texto_codigo, hover_color=ch)
                self.botao_leitura_codigos = CTkButton(self.frame_codigo, text="Ler", image=leitura, fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=ler_descricao, hover_color=ch)
        ...
        def muda_aba_codigo():
            ...
            def escolha_comecar_codigo(escolha):
                if escolha == "Nota":
                    ...
                    self.frame_anota.pack(pady=20)
                    self.botao_voltar_anotas = CTkButton(self.frame_anota, text="Voltar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=voltar_code, hover_color=ch)
                    self.botao_voltar_anotas.place(x=394, y=1)
                    self.tipo_nota = CTkOptionMenu(self.frame_anota, width=90, cursor="hand2", values=["Português", "Matemática", "História", "Geografia", "Ciências", "Inglês", "Programação", "Outros Estudos"], fg_color=cls, height=26, corner_radius=9, button_color=cls, text_color=ctb, button_hover_color=ch, dropdown_fg_color=cls, dropdown_text_color=ctb, dropdown_hover_color=ch, command=muda_titulo)
                    self.tipo_nota.place(x=290, y=110)
                    self.tamanho_fonte = CTkOptionMenu(self.frame_anota, width=90, cursor="hand2", values=["8","10", "12", "14", "16", "18", "20", "22"], fg_color=cls, height=26, corner_radius=9, button_color=cls, text_color=ctb, button_hover_color=ch, dropdown_fg_color=cls, dropdown_text_color=ctb, dropdown_hover_color=ch, command=fonte_tamanho)
                    self.tamanho_fonte.place(x=275, y=150)
                    self.tamanho_fonte.set("Tamanho Da Fonte...")
                    self.tipo_nota.set("Tipo De Notas...")
                    self.titulo = CTkEntry(self.frame_anota, width=222, placeholder_text="Título...", corner_radius=9, border_color=cbp, placeholder_text_color=cbp, text_color=ctt, fg_color=cf)
                    self.titulo.place(x=10, y=80)
                    self.texto = CTkTextbox(self.frame_anota, width=222, height=200, border_width=1, border_color=cbp, corner_radius=9, text_color=ctt, fg_color=cf)
                    self.texto.place(x=10, y=120)
                    self.texto.insert("0.0", "Hoje aprendi sobre...")
                    CTkToolTip(self.texto, message="Clique o botão direito do mouse", alpha=0.81, text_color=ctt, bg_color=cf)
                    self.texto.bind("<Button-3>", apaga_texto)
                    self.botao_salvar = CTkButton(self.frame_anota, text="Salvar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=salvar_texto, hover_color=ch)
                    self.botao_leitura = CTkButton(self.frame_anota, text="Ler", image=leitura, fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=ler, hover_color=ch)
            ...
            def buscar_codigo(evento):
                ...
                if lista_codigo_buscar == True:
                    ...
                    def editar_codigo_busca(evento):
                        ...
                        self.fonte_tamanho_descricao_ec = CTkOptionMenu(self.frame_edita_c, width=90, cursor="hand2", values=["8","10", "12", "14", "16", "18", "20", "22"], fg_color=cls, height=26, corner_radius=9, button_color=cls, text_color=ctb, button_hover_color=ch, dropdown_fg_color=cls, dropdown_text_color=ctb, dropdown_hover_color=ch, command=fonte_tamanho_descricao_e)
                        self.fonte_tamanho_codigo_ec = CTkOptionMenu(self.frame_edita_c, width=90, cursor="hand2", values=["8","10", "12", "14", "16", "18", "20", "22"], fg_color=cls, height=26, corner_radius=9, button_color=cls, text_color=ctb, button_hover_color=ch, dropdown_fg_color=cls, dropdown_text_color=ctb, dropdown_hover_color=ch, command=fonte_tamanho_codigo_e)
                        ...
                        self.titulo_ec = CTkEntry(self.frame_edita_c, width=212, corner_radius=9, border_color=cbp, placeholder_text_color=cbp, text_color=ct, fg_color=cf)
                        self.titulo_ec.bind("<Enter>", muda_titulo_codigo_e)
                        self.texto_codigo_ec = ccb.CTkCodeBox(self.frame_edita_c, width=227, height=150, theme=tema_frame, language=linguagem_frame,fg_color=cf, border_width=1, border_color=cbp, corner_radius=9, numbering_color=cbp, menu=False, font=fonte_codigo_ec)
                        self.descricao_ec = CTkTextbox(self.frame_edita_c, width=212, height=90, border_width=1, border_color=cbp, corner_radius=9, text_color=ct, fg_color=cf, font=fonte_descricao_ec)
                        self.botao_deletar_ec = CTkButton(self.frame_edita_c, text="Deletar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=deletar, hover_color=ch)
                        self.botao_salvar_ec = CTkButton(self.frame_edita_c, text="Salvar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=salvar_texto_codigo_e, hover_color=ch)
                        self.botao_leitura_ec = CTkButton(self.frame_edita_c, text="Ler", image=leitura, fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=ler_ec, hover_color=ch)
                        self.botao_voltar_ec = CTkButton(self.frame_edita_c, text="Voltar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=voltar_anotacao, hover_color=ch)
                    ...
                    self.aba_nota = CTkButton(self.frame_guarda_codigos, text="Notas", fg_color=pg, width=4, height=22, cursor="hand2", corner_radius=9, command=muda_aba_nota_c)
                    self.aba_nota.place(x=4, y=1)
                    self.aba_codigo = CTkButton(self.frame_guarda_codigos, text="Códigos", fg_color=pg, width=4, height=22, cursor="hand2", corner_radius=9, command=muda_aba_codigo)
                    self.aba_codigo.place(x=66, y=1)
                    self.botao_voltar_codigos = CTkButton(self.frame_guarda_codigos, text="Voltar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=voltar_codigos, hover_color=ch)
                    self.botao_voltar_codigos.place(x=365, y=1)
                    self.botao_cria_nota = CTkOptionMenu(self.frame_guarda_codigos, values=["Nota", "Código"], fg_color=cls, height=26, cursor="hand2", corner_radius=19, button_color=cls, text_color=ctb, button_hover_color=ch,dropdown_fg_color=cls, dropdown_text_color=ctb, dropdown_hover_color=ch, command=escolha_comecar_codigo)
                    self.botao_cria_nota.set("Começar...")
                    self.botao_cria_nota.place(x=2, y=33)
                    self.campo_busca_codigo = CTkEntry(master=self.frame_guarda_codigos, width=162, corner_radius=9, border_color=cbp, placeholder_text_color=cbp, text_color=ct, fg_color=cf, placeholder_text="Busque por...")
                    ...
                    for lcb in lista_codigo_buscar:
                        ...
                        if len(texto_bc) > 34:
                            ...
                            texto_bc = texto_bc[0:34]
                        frame_anotacao_cb = CTkFrame(self.frame_codigos, width=180, height=110, corner_radius=9, cursor="hand2", fg_color=cn)
            ...
            self.frame_guarda_codigos = CTkFrame(self.frame_codigos, width=440, height=68, fg_color=pg)
            self.frame_guarda_codigos.pack(pady=10)
            self.aba_nota = CTkButton(self.frame_guarda_codigos, text="Notas", fg_color=pg, width=4, height=22, cursor="hand2", corner_radius=9, command=muda_aba_nota_c, text_color=ct)
            self.aba_nota.place(x=4, y=1)
            self.aba_codigo = CTkButton(self.frame_guarda_codigos, text="Códigos", fg_color=pg, width=4, height=22, cursor="hand2", corner_radius=9, command=muda_aba_codigo, text_color=ct)
            self.aba_codigo.place(x=66, y=1)
            ...
            for lc in self.lista_codigo:
                ...
                if len(texto_c) > 34:
                    ...
                    texto_c = texto_c[0:34]
                frame_anotacao_c = CTkFrame(self.frame_codigos, width=180, height=120, corner_radius=9, cursor="hand2", fg_color=cn)
                ...
                label_titulo_c = CTkLabel(frame_anotacao_c, text=titulo_c, text_color=ct, font=fonte_negrito)
                label_texto_c = CTkLabel(frame_anotacao_c, text=texto_c, text_color=ct, font=fonte_10)
                label_linguagem = CTkLabel(frame_anotacao_c, text=linguagem.capitalize(), text_color=ct, font=fonte_10)
        ...
        def buscar(evento):
            ...
            if texto_busca not in materias:
                lista_nota_buscar = busca_titulo(texto_busca)
            ...
            if lista_nota_buscar == True:
                ...
                def editar_b(evento):
                        ...
                        def ler_titulo_eb():
                            ...
                            if len(titulo_eb) > 3 and len(texto_eb) > 3 and pev == "Ativa":
                                ...
                                voz.runAndWait()
                                    ...
                                    self.erro_nota_eb = CTkLabel(self.frame_editab, text="Tamanho de nota inválida (Min:3, Max:500)!!", text_color="#981212", font=fonte_erros_inter)
                    ...
                    self.frame_editab = CTkFrame(self, width=390, height=310, fg_color=pg)
                    self.frame_editab.pack(pady=20)
                    self.tamanho_fonte_eb = CTkOptionMenu(self.frame_editab, width=90, cursor="hand2", values=["8","10", "12", "14", "16", "18", "20", "22"], fg_color=cls, height=26, corner_radius=9, button_color=cls, text_color=ctb, button_hover_color=ch, dropdown_fg_color=cls, dropdown_text_color=ctb, dropdown_hover_color=ch, command=fonte_tamanho_eb)
                    self.entrada_titulo_eb = CTkEntry(self.frame_editab, width=212, corner_radius=9, border_color=cbp, placeholder_text_color=cbp, text_color="black", fg_color=cf, font=fonte_eb)
                    self.texto_eb = CTkTextbox(self.frame_editab, width=210, height=170, border_width=1, border_color=cbp, corner_radius=9, text_color="black", fg_color=cf, font=fonte_eb)
                    ...
                    self.botao_deletar_eb = CTkButton(self.frame_editab, text="Deletar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=deletar_b, hover_color=ch)
                    self.botao_salvar_eb = CTkButton(self.frame_editab, text="Salvar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=salvar_eb, hover_color=ch)
                    self.botao_leitura_eb = CTkButton(self.frame_editab, text="Ler", image=leitura, fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=ler_eb, hover_color=ch)
                    self.botao_voltar_eb = CTkButton(self.frame_editab, text="Voltar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=voltar_anotacao_b, hover_color=ch)
                    ...
                    self.entrada_titulo_eb.place(x=10, y=41)
                    self.texto_eb.place(x=10, y=89)
                    if materia_b_frame == "Tipo De Notas..." or materia_b_frame == "Outros Estudos":
                        self.tipo_nota_eb.place(x=257, y=100)
                    else:
                        self.tipo_nota_eb.place(x=280, y=100)   
                    self.botao_voltar_eb.place(x=1, y=1) 
                    self.tamanho_fonte_eb.place(x=280, y=41)
                    self.botao_salvar_eb.place(x=230, y=235)
                    self.botao_deletar_eb.place(x=263, y=200)
                    self.botao_leitura_eb.place(x=304, y=235)

                lista_notas = self.frame_notas.winfo_children()
                for ln in lista_notas:
                    ln.destroy()
                self.frame_guarda_notas = CTkFrame(self.frame_notas, width=340, height=70, fg_color=pg)
                self.frame_guarda_notas.pack(pady=10)
                self.botao_voltar_notas = CTkButton(self.frame_guarda_notas, text="Voltar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=voltar_notas_b, hover_color=ch)
                self.botao_voltar_notas.place(x=282, y=1)
                self.botao_cria_nota = CTkOptionMenu(self.frame_guarda_notas, values=["Nota"], fg_color=cls, height=26, cursor="hand2", corner_radius=19, button_color=cls, text_color=ctb, button_hover_color=ch,dropdown_fg_color=cls, dropdown_text_color=ctb, dropdown_hover_color=ch, command=escolha_comecar_b)
                self.botao_cria_nota.set("Começar...")
                self.botao_cria_nota.place(x=2, y=33)
                self.campo_busca = CTkEntry(self.frame_guarda_notas, width=162, corner_radius=9, border_color=cbp,placeholder_text_color=cbp, text_color="black", fg_color=cf, placeholder_text="Busque por...")
                self.campo_busca.place(x=174, y=31)
                ...
                def saiu_campo_busca(evento):
                    self.focus_set()
                    self.campo_busca.configure(placeholder_text="Buscar por...")
                ...
                for lnb in lista_nota_buscar:
                    ...
                    mtr = lnb[3]
                    fonte = lnb[4]
                    #Adiciona as reticências se for maior que 34
                    if len(texto) > 34:
                        if texto[33] == ",":
                            texto = texto[0:33] + "..."
                        else:
                        ...
                        texto = texto[0:34]
                    frame_anotacao_b = CTkFrame(self.frame_notas, width=180, height=120, corner_radius=9, cursor="hand2", fg_color=cn)
                    ...
                    label_titulo = CTkLabel(frame_anotacao_b, text=titulo, text_color=ct, font=fonte_negrito)
                    label_texto = CTkLabel(frame_anotacao_b, text=texto, text_color=ct, font=fonte_10)
                    if mtr != "Tipo De Notas...":#Evita aparecer o nome setado
                        label_materia = CTkLabel(frame_anotacao_b, text=mtr, corner_radius=8, text_color=ct, font=fonte_10)
        ...
        def notas():
            ...
            def escolha_comecar(escolha):
                if escolha == "Nota":
                    ...
                    self.frame_anota = CTkFrame(self, width=400, height=260, fg_color=pg)
                    self.frame_anota.pack(pady=20)
                    self.botao_voltar_anotas = CTkButton(self.frame_anota, text="Voltar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=voltar_anota, hover_color=ch)
                    self.botao_voltar_anotas.place(x=330, y=1)
                    self.tipo_nota = CTkOptionMenu(self.frame_anota, width=90, cursor="hand2", values=["Português", "Matemática", "História", "Geografia", "Ciências", "Inglês", "Programação" "Outros Estudos"], fg_color=cls, height=26, corner_radius=9, button_color=cls, text_color=ctb, button_hover_color=ch, dropdown_fg_color=cls, dropdown_text_color=ctb, dropdown_hover_color=ch, command=muda_titulo)
                    self.tipo_nota.place(x=240, y=50)
                    self.tamanho_fonte = CTkOptionMenu(self.frame_anota, width=90, cursor="hand2", values=["8","10", "12", "14", "16", "18", "20", "22"], fg_color=cls, height=26, corner_radius=9, button_color=cls, text_color=ctb, button_hover_color=ch, dropdown_fg_color=cls, dropdown_text_color=ctb, dropdown_hover_color=ch, command=fonte_tamanho)
                    ...
                    self.botao_salvar = CTkButton(self.frame_anota, text="Salvar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=salvar_texto, hover_color=ch)
                    self.botao_salvar.place(x=230, y=235)
                    self.botao_ler = CTkButton(self.frame_anota, text="Ler", fg_color=cls, width=4, height=22, image=leitura, border_width=0, corner_radius=9, cursor="hand2", command=ler_GUI, hover_color=ch)
                    self.botao_ler.place(x=305, y=235)
                elif escolha == "Código":
                    def voltar_codigo():
                        self.frame_codigo.pack_forget()
                        self.frame_notas.place(x=20, y=0)
                    ...
                    self.frame_codigo = CTkFrame(self, width=470, height=360, fg_color=pg)
                    self.frame_codigo.pack(pady=20)
                    self.botao_voltar_codigo = CTkButton(self.frame_codigo, text="Voltar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=voltar_codigo, hover_color=ch)
                    self.botao_voltar_codigo.place(x=404, y=1)
                    self.fonte_tamanho_codigo = CTkOptionMenu(self.frame_codigo, width=90, cursor="hand2", values=["8","10", "12", "14", "16", "18", "20", "22"], fg_color=cls, height=26, corner_radius=9, button_color=cls, text_color=ctb, button_hover_color=ch, dropdown_fg_color=cls, dropdown_text_color=ctb, dropdown_hover_color=ch, command=fonte_tamanho_codigo)
                    self.fonte_tamanho_codigo.place(x=4, y=25)
                    self.fonte_tamanho_codigo.set("Tamanho Da Fonte...")
            ...
            def editar(evento):
                    ...
                    def ler_titulo_e():
                        ...
                        if len(titulo_e) > 3 and len(texto_e) > 3 and pev == "Ativa":
                            ...
                            def tira_ativa_voz_e():
                                ...
                                self.botao_leitura_e.configure(state=NORMAL)
                            self.label_ative_voz_e = CTkLabel(self.frame_edita, text="Ative a Voz!", text_color="#E21010", font=fonte_erros_inter)
                ...
                self.tamanho_fonte_e = CTkOptionMenu(self.frame_edita, width=90, cursor="hand2", values=["8","10", "12", "14", "16", "18", "20", "22"], fg_color=cls, height=26, corner_radius=9, button_color=cls, text_color=ctb, button_hover_color=ch, dropdown_fg_color=cls, dropdown_text_color=ctb, dropdown_hover_color=ch, command=fonte_tamanho_e)
                self.entrada_titulo_e = CTkEntry(self.frame_edita, width=212, corner_radius=9, border_color=cbp, placeholder_text_color=cbp, text_color="black", fg_color=cf, font=fonte_e)
                self.texto_e = CTkTextbox(self.frame_edita, width=210, height=170, border_width=1, border_color=cbp, corner_radius=9, text_color="black", fg_color=cf, font=fonte_e)
                ...
                self.botao_leitura_e = CTkButton(self.frame_edita, text="Ler", image=leitura, fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=ler_e, hover_color=ch)
                self.botao_deletar_e = CTkButton(self.frame_edita, text="Deletar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=deletar, hover_color=ch)
                self.botao_salvar_e = CTkButton(self.frame_edita, text="Salvar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=salvar_e, hover_color=ch)
                self.botao_voltar_e = CTkButton(self.frame_edita, text="Voltar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=voltar_anotacao, hover_color=ch)
                ...
                self.botao_salvar_e.place(x=230, y=235)
                self.botao_deletar_e.place(x=262, y=200)
                self.botao_leitura_e.place(x=300, y=235)

            self.frame_notas = CTkScrollableFrame(self, width=390, height=280, fg_color=pg)
            self.frame_notas.place(x=20, y=0)
            self.frame_guarda_notas = CTkFrame(self.frame_notas, width=340, height=70, fg_color=pg)
            self.frame_guarda_notas.pack(pady=10)
            self.botao_voltar_notas = CTkButton(self.frame_guarda_notas, text="Voltar", fg_color=cls, width=4, height=22, border_width=0, corner_radius=9, cursor="hand2", command=voltar_notas, hover_color=ch)
            self.botao_voltar_notas.place(x=282, y=1)
            self.botao_cria_nota = CTkOptionMenu(self.frame_guarda_notas, values=["Nota"], fg_color=cls, height=26, cursor="hand2", corner_radius=19, button_color=cls, text_color=ctb, button_hover_color=ch,dropdown_fg_color=cls, dropdown_text_color=ctb, dropdown_hover_color=ch, command=escolha_comecar)
            self.botao_cria_nota.set("Começar...")
            self.botao_cria_nota.place(x=2, y=33)
            self.campo_busca = CTkEntry(self.frame_guarda_notas, width=162, corner_radius=9, border_color=cbp, placeholder_text_color=cbp, text_color=ct, fg_color=cf, placeholder_text="Busque por...")
            self.campo_busca.place(x=174, y=31)
            CTkToolTip(self.campo_busca, message="Clique a tecla ENTER", alpha=0.81, text_color=ctt, bg_color=cf)
            self.campo_busca.bind("<Return>", buscar)
            def entrou_campo_busca(evento):
            ...
            for ln in self.lista_nota:
                ...
                if len(texto) > 34:
                    ...
                    texto = texto[0:34]
                mtr = ln[3]
                frame_anotacao = CTkFrame(self.frame_notas, width=180, height=120, corner_radius=9, cursor="hand2", fg_color=cn)
                ...
                if mtr != "Tipo De Notas...":#Evita aparecer o nome setado
                    label_materia = CTkLabel(frame_anotacao, text=mtr, corner_radius=9, text_color=ct)
        ...
        def config():
            ...
            self.title("Sponte Study")
            self.frame_config = CTkScrollableFrame(self, width=400, height=270, fg_color=pg)
            self.frame_config.place(x=14, y=8)

            if vfc == True and pev == "Ativa":
                self.thread_aviso_config = threading.Thread(target=aviso_config, daemon=True)
                self.thread_aviso_config.start()
                falou = True
                ja_falou_config(falou)
            ...
            self.cores_fundo = CTkOptionMenu(self.frame_config, values=["Padrão", "Noite", "Branco", "Amor", "Azul", "Praia", "Melancia", "Algodão-Doce", "Urso De Pelúcia", "Azul Meia-Noite\n Intenso"], corner_radius=9, cursor="hand2", height=26, fg_color=cls, button_color=cls, text_color=ctb, button_hover_color=ch, dropdown_fg_color=cls, dropdown_text_color=ctb, dropdown_hover_color=ch, command=cor_fundo)
            self.cores_fundo.set("Sua Cor De Fundo...")
            self.cores_fundo.pack(pady=8)
            self.entrada_hexa = CTkEntry(self.frame_config, placeholder_text="Digite a cor hexa...", placeholder_text_color=cbp, corner_radius=9, border_color=cbp, width=140, text_color=cth, fg_color=cf)
            ...
            self.botao_enviar_hexa = CTkButton(self.frame_config, text="Validar", text_color=ctb, fg_color=cls, border_width=0, corner_radius=9, width=4, height=19, cursor="hand2", command=valida_hexa, hover_color=ch)
            self.botao_enviar_hexa.place(x=275, y=189)
            self.botao_voltar_config = CTkButton(self.frame_config, text="Voltar", text_color=ctb, fg_color=cls, border_width=0, corner_radius=9, width=4, height=22, cursor="hand2", command=voltar_config, hover_color=ch)
        ...
        self.frame_central = CTkFrame(self, width=300, height=268, fg_color=pg, corner_radius=14)
        self.frame_central.pack(pady=22)
        self.label_hora = CTkLabel(self.frame_central, width=260, height=100, text=horario_atual, text_color=cls, font=fonte_hora, bg_color="transparent")
        self.label_hora.place(x=20, y=16)
        self.label_data = CTkLabel(self.frame_central, width=260, height=28, bg_color="transparent", text=data_atual, font=fonte_data, text_color=ct)
        self.label_data.place(x=20, y=108)
        self.linha_sep = CTkFrame(self.frame_central, width=260, height=2, fg_color=cls, corner_radius=2)
        self.linha_sep.place(x=20, y=140)
        self.botao_notas = CTkButton(self.frame_central, text="Notas", text_color=ctb, width=120, height=36, cursor="hand2", fg_color=cls, border_width=0, corner_radius=9, font=CTkFont(family="Helvetica", size=13, weight="bold"), command=notas, hover_color=ch)
        self.botao_notas.place(x=20, y=152)
        self.botao_configuracoes = CTkButton(self.frame_central, text="Config", text_color=ctb, width=120, height=36, cursor="hand2", fg_color=cls, border_width=0, corner_radius=9, font=CTkFont(family="Helvetica", size=13, weight="bold"), command=config, hover_color=ch)
        self.botao_configuracoes.place(x=158, y=152)
        self.label_ajuda = CTkLabel(self.frame_central, text="Seu app de organização\ncom voz 100% offline", font=fonte_ajuda, text_color=ct, justify="center")
        self.label_ajuda.place(x=55, y=210)
