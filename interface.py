...
class janela_inic(CTk):
    def __init__(self):
        ...
        self.label_logus = CTkLabel(
            self, text="Sponte Study", text_color="#105ba0", font=(self.fonte_titulo)
        )
        self.label_logus.pack(pady=30)
        self.inicializacao = CTkLabel(
            self, text="Inicializando...", text_color="#105ba0", font=(self.fonte_inic)
        )
        self.inicializacao.pack(pady=40)
        self.bem_vindo = CTkLabel(
            self, text="Boas Vindas", text_color="#105ba0", font=(self.fonte_inic)
        )
...
class janela_preench(CTk):
    def __init__(self):
        ...
        self.titulo = CTkLabel(
            self, text="Conhecendo-te", font=(self.fonte_conhecer), text_color="#105ba0"
        )
        ...
        def enviando():
            ...
            if len(nome) > 2 and len(idade) > 0 and len(mnome) > 1 and len(niver) >= 3:
                if (
                    any(x in caracteres_invalidos for x in nome)
                    or not idade.isdigit()
                    or any(y in caracteres_invalidos for y in mnome)
                    or any(z in caracteres_invalidos_niver for z in niver)
                ):
                    ...
                    erro_caractere = CTkLabel(
                        self,
                        text="Erro: Caracteres Inválidos!",
                        text_color="#E21010",
                        font=self.fonte_erros,
                    )
                    erro_caractere.place(x=190, y=390)
                    self.after(1200, erro_caractere.destroy)
                    self.after(1200, habilitar_caractere)
                elif (
                    all(not x in caracteres_invalidos for x in nome)
                    and idade.isdigit()
                    and all(not y in caracteres_invalidos for y in mnome)
                    and all(not z in caracteres_invalidos_niver for z in niver)
                ):
                    idade = int(idade)
                    ...
                    if idade <= 5:
                        ...
                        erro_idade5 = CTkLabel(
                            self,
                            text="Erro: Menor De Idade!",
                            text_color="#E21010",
                            font=self.fonte_erros,
                        )
                        ...
                        erro_dia = CTkLabel(
                            self,
                            text="Erro: Data De Aniversário Inválida!",
                            text_color="#E21010",
                            font=self.fonte_erros,
                        )
                        ...
                        erro_tamanho = CTkLabel(
                            self,
                            text=f"Erro: Tamanho De Caracteres No Primeiro, \nSegundo ou Terceiro Campos Muito Grandes!",
                            text_color="#E21010",
                            font=self.fonte_erros,
                        )
                ...
                erro_vazio = CTkLabel(
                    self,
                    text="Erro: Preêncha os campos corretamente!",
                    fg_color="#EEEBEB",
                    text_color="#E21010",
                    font=self.fonte_erros,
                )
        ...
        self.nome_caixa = CTkEntry(
            self,
            width=170,
            placeholder_text="Digite seu nome...",
            placeholder_text_color="#105ba0",
            corner_radius=15,
            border_color="#105ba0",
        )
        self.idade_caixa = CTkEntry(
            self,
            width=170,
        ...
        self.data_nasci = CTkEntry(
            self,
            width=180,
            placeholder_text="Digite sua data de niver...",
            placeholder_text_color="#105ba0",
            corner_radius=15,
            border_color="#105ba0",
        )
        self.data_nasci.bind("<Enter>", inserirbarra)
        self.meunome_caixa = CTkEntry(
            self,
            width=178,
            placeholder_text="Como deseja me chamar?",
            placeholder_text_color="#105ba0",
            corner_radius=15,
            border_color="#105ba0",
        )
...
class janela_principal(CTk):
    def __init__(self):
        ...
        alerta = CTkImage(
            Image.open(os.path.join(imagem_pasta, caminho_alerta)), size=(17, 17)
        )
        leitura = CTkImage(
            Image.open(os.path.join(imagem_pasta, caminho_leitura)), size=(13, 13)
        )
        ...
        def reiniciar_saudacao():
            self.thread_reinicia_saudacao = threading.Thread(
                target=reiniciar_ciclo_saudacao, daemon=True
            )
        ...
        def escolha_comecar_b(escolha):
            if escolha == "Nota":
                ...
                def salvar_texto_b():
                    ...
                    if materia == "Tipo De Notas...":
                        ...
                        if verificacao == False:
                            ...
                            self.label_salvo = CTkLabel(
                                self.frame_anota,
                                text="Salvo com sucesso!!",
                                text_color="#2E6F40",
                                font=fonte_erros_inter,
                                fg_color=pg,
                            )
                            ...
                            self.label_erro_salvo = CTkLabel(
                                self.frame_anota,
                                text="Não Salvou!!!",
                                text_color="#E21010",
                                font=fonte_erros_inter,
                        ...
                        self.erro_titulo = CTkLabel(
                            self.frame_anota,
                            text="Tamanho de título inválido (Min:3, Max:30)!!",
                            text_color="#E21010",
                            font=fonte_erros_inter,
                        )
                        ...
                        self.erro_nota = CTkLabel(
                            self.frame_anota,
                            text="Tamanho de nota inválido (Min:3, Max:500)!!",
                            text_color="#E21010",
                            font=fonte_erros_inter,
                        )
                ...
                def muda_titulo_b(nota_escolha):
                    if nota_escolha == "Português":
                        self.titulo.configure(
                            placeholder_text="Gramática, literatura, redação..."
                        )
                        self.tipo_nota.configure(
                            fg_color="#FF8DA1",
                            button_color="#FF8DA1",
                            button_hover_color="#E67E91",
                        )
                    elif nota_escolha == "Matemática":
                        self.titulo.configure(
                            placeholder_text="Frações, funções, regra de três..."
                        )
                        self.tipo_nota.configure(
                            fg_color="#1591EA",
                            button_color="#1591EA",
                            button_hover_color="#127BC6",
                        )
                    elif nota_escolha == "História":
                        self.titulo.configure(
                            placeholder_text="Brasil, revoluções, guerras..."
                        )
                        self.tipo_nota.configure(
                            fg_color="#FFA500",
                            button_color="#FFA500",
                            button_hover_color="#E39400",
                        )
                    elif nota_escolha == "Geografia":
                        self.titulo.configure(
                            placeholder_text="Clima, relevo, globalização..."
                        )
                        self.tipo_nota.configure(
                            fg_color="#50C878",
                            button_color="#50C878",
                            button_hover_color="#46AC68",
                        )
                    elif nota_escolha == "Ciências":
                        self.titulo.configure(
                            placeholder_text="Física, química, biologia..."
                        )
                        self.tipo_nota.configure(
                            fg_color="#2E6F40",
                            button_color="#2E6F40",
                            button_hover_color="#328A51",
                        )
                    elif nota_escolha == "Inglês":
                        self.titulo.configure(
                            placeholder_text="Conectivos, dia a dia, pronouns..."
                        )
                        self.tipo_nota.configure(
                            fg_color="#C9A41D",
                            button_color="#C9A41D",
                            button_hover_color="#B6941B",
                        )
                    else:
                        self.titulo.configure(placeholder_text="Título...")
                        self.tipo_nota.configure(
                            fg_color=cls, button_color=cls, button_hover_color=ch
                        )
                ...
                def ler_b():
                    ...
                    def ler_titulo_b():
                        ...
                        if len(titulo_b) >= 3 and len(texto_b) >= 3 and pev == "Ativa":
                            ...
                            self.erro_nota_b = CTkLabel(
                                self.frame_anota,
                                text="Tamanho de nota inválida (Min:3, Max:500)!!",
                                text_color="#981212",
                                font=fonte_erros_inter,
                            )
                            ...
                            self.label_ative_voz_b = CTkLabel(
                                self.frame_anota,
                                text="Ative a Voz!",
                                text_color="#E21010",
                                font=fonte_erros_inter,
                    ...
                    self.thread_ler_titulo_b = threading.Thread(
                        target=ler_titulo_b, daemon=True
                    )
                ...
                self.botao_voltar_anotas = CTkButton(
                    self.frame_anota,
                    text="Voltar",
                    fg_color=cls,
                    width=4,
                    ...
                    corner_radius=23,
                    cursor="hand2",
                    command=voltar_anota_b,
                    hover_color=ch,
                )
                self.botao_voltar_anotas.place(x=394, y=1)
                self.tipo_nota = CTkOptionMenu(
                    self.frame_anota,
                    width=90,
                    cursor="hand2",
                    values=[
                    ...
                    button_color=cls,
                    text_color=ctb,
                    button_hover_color=ch,
                    dropdown_fg_color=cls,
                    dropdown_text_color=ctb,
                    dropdown_hover_color=ch,
                    command=muda_titulo_b,
                )
                self.tipo_nota.place(x=290, y=110)
                self.tamanho_fonte = CTkOptionMenu(
                    self.frame_anota,
                    width=90,
                    cursor="hand2",
                    values=["8", "10", "12", "14", "16", "18", "20", "22"],
                    fg_color=cls,
                    height=25,
                    corner_radius=15,
                    button_color=cls,
                    ...
                    dropdown_text_color=ctb,
                    dropdown_hover_color=ch,
                    command=fonte_tamanho_b,
                )
                self.tamanho_fonte.place(x=275, y=150)
                self.tamanho_fonte.set("Tamanho Da Fonte...")
                self.tipo_nota.set("Tipo De Notas...")
                self.titulo = CTkEntry(
                    self.frame_anota,
                    width=222,
                    placeholder_text="Título...",
                    corner_radius=10,
                    border_color=cbp,
                    placeholder_text_color=cbp,
                    text_color=ctt,
                    fg_color=cf,
                )
                self.titulo.place(x=10, y=80)
                self.texto = CTkTextbox(
                    self.frame_anota,
                    width=222,
                    height=200,
                    border_width=2,
                ...
                CTkToolTip(
                    self.texto,
                    message="Clique o botão direito do mouse",
                    alpha=0.81,
                    text_color=ctt,
                    bg_color=cf,
                )
                ...
                self.botao_salvar = CTkButton(
                    ...
                    corner_radius=23,
                    cursor="hand2",
                    command=salvar_texto_b,
                    hover_color=ch,
                )
                self.botao_salvar.place(x=238, y=295)
                self.botao_leitura_b = CTkButton(
                    self.frame_anota,
                    text="Ler",
                    image=leitura,
                    fg_color=cls,
                ...
                def salvar_texto_codigo():
                    ...
                    if (
                        ...
                        self.erro_nota = CTkLabel(
                            self.frame_codigo,
                            text="Tamanho de descrição\n inválida (Min:3, Max:500)!!",
                            text_color="#E21010",
                            font=fonte_erros_inter,
                        )
                ...
                def ler_descricao():
                    ...
                    def ler_texto():
                        ...
                        if (
                            ...
                            self.erro_nota = CTkLabel(
                                self.frame_codigo,
                                text="Tamanho de descrição inválida (Min:3, Max:500)!!",
                                text_color="#981212",
                                font=fonte_erros_inter,
                            )
                            self.erro_nota.place(x=245, y=30)
                    ...
                    self.thread_ler_descricao = threading.Thread(
                        target=ler_texto, daemon=True
                    )
                    self.thread_ler_descricao.start()

                def muda_titulo_codigo(evento):
                    self.titulo_codigo.configure(
                        placeholder_text="Projeto, função de, conceito..."
                    )

                self.frame_notas.place_forget()
                self.frame_codigo = CTkFrame(self, width=470, height=360, fg_color=pg)
                self.frame_codigo.pack(pady=20)
                self.botao_voltar_codigo = CTkButton(
                    self.frame_codigo,
                    text="Voltar",
                    fg_color=cls,
                    width=4,
                ...
                self.fonte_tamanho_codigo = CTkOptionMenu(
                    ...
                    dropdown_text_color=ctb,
                    dropdown_hover_color=ch,
                    command=fonte_tamanho_codigo,
                )
                self.fonte_tamanho_codigo.place(x=4, y=25)
                self.fonte_tamanho_codigo.set("Tamanho Da Fonte...")
                self.texto_codigo = ccb.CTkCodeBox(
                    self.frame_codigo,
                    width=227,
                    height=160,
                    theme="arduino",
                ...
                self.linguagem.set("Sua Linguagem Favorita...")
                self.fonte_tamanho_descricao = CTkOptionMenu(
                    self.frame_codigo,
                    width=90,
                    cursor="hand2",
                    values=["8", "10", "12", "14", "16", "18", "20", "22"],
                    ...
                    dropdown_text_color=ctb,
                    dropdown_hover_color=ch,
                    command=fonte_tamanho_descricao,
                )
                self.fonte_tamanho_descricao.place(x=282, y=115)
                self.fonte_tamanho_descricao.set("Tamanho Da Fonte...")
                self.titulo_codigo = CTkEntry(
                    self.frame_codigo,
                    width=212,
                    border_width=2,
                    border_color=cbp,
                ...
                self.botao_salvar = CTkButton(
                    ...
                    corner_radius=23,
                    cursor="hand2",
                    command=salvar_texto_codigo,
                    hover_color=ch,
                )
                self.botao_leitura_codigos = CTkButton(
                    self.frame_codigo,
                    text="Ler",
                    image=leitura,
                    fg_color=cls,
        ...
        def muda_aba_codigo():
                ...
                if escolha == "Nota":
                    ...
                    def muda_titulo(nota_escolha):
                        if nota_escolha == "Português":
                            ...
                            self.titulo.configure(
                                placeholder_text="Física, química, biologia, energia..."
                            )
                            self.tipo_nota.configure(
                                fg_color="#2E6F40",
                                button_color="#2E6F40",
                            ...
                            self.titulo.configure(
                                placeholder_text="POO, variáveis, condicionais..."
                            )
                            self.tipo_nota.configure(
                                fg_color="#236BAF",
                                button_color="#236BAF",
                                button_hover_color="#1F63A3",
                            )
                            self.texto.delete("0.0", "end")
                    ...
                    def ler():
                        ...
                        self.thread_ler_titulo = threading.Thread(
                            target=ler_titulo, daemon=True
                        )
                        self.thread_ler_titulo.start()

                    self.frame_codigos.place_forget()
                    self.frame_anota = CTkFrame(
                        self, width=450, height=340, fg_color=pg
                    )
                    self.frame_anota.pack(pady=20)
                    self.botao_voltar_anotas = CTkButton(
                        self.frame_anota,
                    ...
                    self.botao_salvar = CTkButton(
                        ...
                        corner_radius=23,
                        cursor="hand2",
                        command=salvar_texto,
                        hover_color=ch,
                    )
                    self.botao_leitura = CTkButton(
                        self.frame_anota,
                        text="Ler",
                        image=leitura,
                        fg_color=cls,
                    ...
                    def salvar_texto_codigo():
                        ...
                        titulo_codigo = self.titulo_codigo.get().strip().capitalize()
                        descricao = (
                            self.descricao.get("1.0", "end").strip().capitalize()
                        )
                        codigo = self.texto_codigo.get("1.0", "end").strip()
                        fonte_codigo = self.fonte_tamanho_codigo.get()
                        fonte_descricao = self.fonte_tamanho_descricao.get()
                        ...
                        if (
                            ...
                            if verificacao == False:
                                ...
                                def tira_salvo():
                                    ...
                                    self.titulo_codigo.delete(0, "end")
                                    self.descricao.delete("1.0", "end")
                                    self.fonte_tamanho_descricao.set(
                                        "Tamanho Da Fonte..."
                                    )
                                    self.fonte_tamanho_codigo.set("Tamanho Da Fonte...")
                                    self.tema.set("Seu Tema Favorito...")
                    ...
                    self.frame_codigos.place_forget()
                    self.frame_codigo = CTkFrame(
                        self, width=470, height=360, fg_color=pg
                    )
                    self.frame_codigo.pack(pady=20)
                    self.botao_voltar_codigo = CTkButton(
                        self.frame_codigo,
                ...
                if lista_codigo_buscar == True:
                    ...
                    def editar_codigo_busca(evento):
                        ...
                        def salvar_texto_codigo_e():
                            ...
                            descricao_e = (
                                self.descricao_ec.get("1.0", "end").strip().capitalize()
                            )
                            ...
                            if linguagem_e == "sua linguagem favorita...":
                                linguagem_e = "python"
                            if (
                                len(titulo_codigo_e) >= 3
                                and len(titulo_codigo_e) < 30
                                and len(descricao_e) >= 3
                                and len(descricao_e) < 500
                                and len(codigo_e) >= 3
                            ):
                                salvando_codigo = salvar_edicao_codigo(
                                    titulo_codigo_e,
                                    id,
                                    descricao_e,
                                    fonte_descricao_ec,
                        ...
                        def ler_ec():
                            ...
                            def ler_titulo_ec():
                                ...
                                if (
                                    ...
                                    self.label_ative_voz_ec = CTkLabel(
                                        self.frame_edita_c,
                                        text="Ative a Voz!",
                                        text_color="#E21010",
                                        font=fonte_erros_inter,
                            ...
                            self.thread_ler_titulo_ec = threading.Thread(
                                target=ler_titulo_ec, daemon=True
                            )
                        ...
                        fonte_descricao_ec = CTkFont(
                            family="Arial", size=fonte_descricao_frame_c
                        )
                        fonte_codigo_ec = CTkFont(
                            family="Arial", size=fonte_codigo_frame_c
                        )
                        self.frame_edita_c = CTkFrame(
                            self, width=470, height=350, fg_color=pg
                        )
                        self.frame_edita_c.pack(pady=20)
                        self.fonte_tamanho_descricao_ec = CTkOptionMenu(
                            self.frame_edita_c,
                            width=90,
                            cursor="hand2",
                            values=["8", "10", "12", "14", "16", "18", "20", "22"],
                            ...
                            dropdown_text_color=ctb,
                            dropdown_hover_color=ch,
                            command=fonte_tamanho_descricao_e,
                        )
                        self.fonte_tamanho_codigo_ec = CTkOptionMenu(
                            self.frame_edita_c,
                            width=90,
                            cursor="hand2",
                            values=["8", "10", "12", "14", "16", "18", "20", "22"],
                            ...
                            dropdown_text_color=ctb,
                            dropdown_hover_color=ch,
                            command=fonte_tamanho_codigo_e,
                        )
                        self.tema_ec = CTkOptionMenu(
                            self.frame_edita_c,
                            width=90,
                            cursor="hand2",
                            values=[
                        ...
                        self.linguagem_ec = CTkOptionMenu(
                            self.frame_edita_c,
                            width=90,
                            cursor="hand2",
                            values=[
                        ...
                        self.texto_codigo_ec = ccb.CTkCodeBox(
                            self.frame_edita_c,
                            width=227,
                            height=150,
                            theme=tema_frame,
                            language=linguagem_frame,
                            fg_color=cf,
                            border_width=2,
                            border_color=cbp,
                            corner_radius=10,
                            numbering_color=cbp,
                            menu=False,
                            font=fonte_codigo_ec,
                        )
                        self.descricao_ec = CTkTextbox(
                            self.frame_edita_c,
                            width=212,
                            height=90,
                            border_width=2,
                            ...
                            text_color=ct,
                            fg_color=cf,
                            font=fonte_descricao_ec,
                        )
                        self.botao_deletar_ec = CTkButton(
                            self.frame_edita_c,
                            text="Deletar",
                            fg_color=cls,
                            width=4,
                        ...
                        self.botao_salvar_ec = CTkButton(
                            self.frame_edita_c,
                            text="Salvar",
                            fg_color=cls,
                            width=4,
                            ...
                            corner_radius=23,
                            cursor="hand2",
                            command=salvar_texto_codigo_e,
                            hover_color=ch,
                        )
                        self.botao_leitura_ec = CTkButton(
                            self.frame_edita_c,
                            text="Ler",
                            image=leitura,
                            fg_color=cls,
                        ...
                        self.botao_voltar_ec = CTkButton(
                            self.frame_edita_c,
                            text="Voltar",
                            fg_color=cls,
                            width=4,
                    ...
                    self.frame_notas.place_forget()
                    self.frame_codigos = CTkScrollableFrame(
                        self, width=440, height=330, fg_color=pg
                    )
                    self.frame_codigos.place(x=20, y=0)
                    self.frame_guarda_codigos = CTkFrame(
                        self.frame_codigos, width=440, height=68, fg_color=pg
                    )
                    self.frame_guarda_codigos.pack(pady=10)
                    self.aba_nota = CTkButton(
                        self.frame_guarda_codigos,
                        text="Notas",
                        fg_color=pg,
                        width=4,
                        ...
                        cursor="hand2",
                        corner_radius=23,
                        command=muda_aba_nota_c,
                    )
                    self.aba_nota.place(x=4, y=1)
                    self.aba_codigo = CTkButton(
                        self.frame_guarda_codigos,
                        text="Códigos",
                        fg_color=pg,
                        width=4,
                        ...
                        cursor="hand2",
                        corner_radius=23,
                        command=muda_aba_codigo,
                    )
                    self.aba_codigo.place(x=66, y=1)
                    self.botao_voltar_codigos = CTkButton(
                        self.frame_guarda_codigos,
                        text="Voltar",
                        fg_color=cls,
                        width=4,
                        ...
                        corner_radius=23,
                        cursor="hand2",
                        command=voltar_codigos,
                        hover_color=ch,
                    )
                    self.botao_voltar_codigos.place(x=365, y=1)
                    self.botao_cria_nota = CTkOptionMenu(
                        self.frame_guarda_codigos,
                        values=["Nota", "Código"],
                        fg_color=cls,
                        height=25,
                        ...
                        dropdown_text_color=ctb,
                        dropdown_hover_color=ch,
                        command=escolha_comecar_codigo,
                    )
                    self.botao_cria_nota.set("Começar...")
                    self.botao_cria_nota.place(x=2, y=33)
                    self.campo_busca_codigo = CTkEntry(
                        master=self.frame_guarda_codigos,
                        width=162,
                        corner_radius=10,
                        border_color=cbp,
                        placeholder_text_color=cbp,
                        text_color=ct,
                        fg_color=cf,
                        placeholder_text="Busque por...",
                    )
                    self.campo_busca_codigo.place(x=260, y=31)
                    CTkToolTip(
                        self.campo_busca_codigo,
                        message="Clique a tecla ENTER",
                        alpha=0.81,
                        text_color=ctt,
                        bg_color=cf,
                    )
                    ...
                    def entrou_campo_busca_codigo(evento):
                        self.campo_busca_codigo.configure(
                            placeholder_text="Título, lang..."
                        )
                    ...
                    for lcb in lista_codigo_buscar:
                        ...
                        frame_anotacao_cb.ID = lcb[
                            0
                        ]  # Atribuindo o atributo ID aos frames, cada qual com seu id
                        frame_anotacao_cb.titulo = lcb[1]
                        frame_anotacao_cb.texto = lcb[2]
                        frame_anotacao_cb.fonte = lcb[4]
                        label_titulo_cb = CTkLabel(
                            frame_anotacao_cb, text=titulo_bc, text_color=ct
                        )
                        label_texto_cb = CTkLabel(
                            frame_anotacao_cb, text=texto_bc, text_color=ct
                        )
                        label_linguagem_cb = CTkLabel(
                            frame_anotacao_cb, text=linguagem_bc, text_color=ct
                        )
            ...
            for lc in self.lista_codigo:
                ...
                label_titulo_c = CTkLabel(
                    frame_anotacao_c, text=titulo_c, text_color=ct
                )
                label_texto_c = CTkLabel(frame_anotacao_c, text=texto_c, text_color=ct)
                label_linguagem = CTkLabel(
                    frame_anotacao_c, text=linguagem.capitalize(), text_color=ct
                )
            ...
            if lista_nota_buscar == True:
                ...
                def editar_b(evento):
                    ...
                    def muda_titulo_eb(nota_escolha):
                        if nota_escolha == "Português":
                            self.entrada_titulo_eb.configure(
                                placeholder_text="Gramática, literatura, redação..."
                            )
                            self.tipo_nota_eb.configure(
                                fg_color="#FF8DA1",
                                button_color="#FF8DA1",
                                button_hover_color="#E67E91",
                            )
                    ...
                    def salvar_eb():
                        ...
                        salvando = salvar_edicao(
                            data_edicao_nota, id, titulo_e, texto_e, tipo_nota, fonte_e
                        )
                        if salvando == True:
                            self.label_sal = CTkLabel(
                                self.frame_editab,
                                text="Salvo com sucesso!!",
                                text_color="#2E6F40",
                                font=fonte_erros_inter,
                    ...
                    def ler_eb():
                        ...
                        def ler_titulo_eb():
                            ...
                            if (
                                ...
                                self.label_ative_voz_eb = CTkLabel(
                                    self.frame_editab,
                                    text="Ative a Voz!",
                                    text_color="#E21010",
                                    font=fonte_erros_inter,
                        ...
                        self.thread_ler_titulo_eb = threading.Thread(
                            target=ler_titulo_eb, daemon=True
                        )
                        self.thread_ler_titulo_eb.start()

                    def negrito_eb(evento):
                        self.texto_eb._textbox.tag_add(
                            "negrito", "sel.first", "sel.last"
                        )
                        self.texto_eb._textbox.tag_configure(
                            "negrito", font=fonte_negrito
                        )
                    ...
                    self.frame_editab = CTkFrame(
                        self, width=470, height=350, fg_color=pg
                    )
                    self.frame_editab.pack(pady=20)
                    self.tamanho_fonte_eb = CTkOptionMenu(
                        self.frame_editab,
                        width=90,
                        cursor="hand2",
                        values=["8", "10", "12", "14", "16", "18", "20", "22"],
                        ...
                        dropdown_text_color=ctb,
                        dropdown_hover_color=ch,
                        command=fonte_tamanho_eb,
                    )
                    self.entrada_titulo_eb = CTkEntry(
                        self.frame_editab,
                        width=212,
                        corner_radius=10,
                        border_color=cbp,
                    ...
                    self.tipo_nota_eb = CTkOptionMenu(
                        self.frame_editab,
                        width=90,
                        cursor="hand2",
                        values=[
                        ...
                        dropdown_text_color=ctb,
                        dropdown_hover_color=ch,
                        command=muda_titulo_eb,
                    )
                    self.botao_deletar_eb = CTkButton(
                        self.frame_editab,
                        text="Deletar",
                        fg_color=cls,
                        width=4,
                    ...
                    self.botao_salvar_eb = CTkButton(
                        self.frame_editab,
                        text="Salvar",
                        fg_color=cls,
                        width=4,
                    ...
                    self.botao_leitura_eb = CTkButton(
                        self.frame_editab,
                        text="Ler",
                        image=leitura,
                        fg_color=cls,
                    ...
                    self.botao_voltar_eb = CTkButton(
                        self.frame_editab,
                        text="Voltar",
                        fg_color=cls,
                        width=4,
                    ...
                    if (
                        materia_b_frame == "Tipo De Notas..."
                        or materia_b_frame == "Outros Estudos"
                    ):
                ...
                for ln in lista_notas:
                    ln.destroy()
                self.frame_guarda_notas = CTkFrame(
                    self.frame_notas, width=440, height=68, fg_color=pg
                )
                self.frame_guarda_notas.pack(pady=10)
                self.botao_voltar_notas = CTkButton(
                    self.frame_guarda_notas,
                    text="Voltar",
                    fg_color=cls,
                    width=4,
                ...
                self.botao_cria_nota = CTkOptionMenu(
                    ...
                    dropdown_text_color=ctb,
                    dropdown_hover_color=ch,
                    command=escolha_comecar_b,
                )
                self.botao_cria_nota.set("Começar...")
                self.botao_cria_nota.place(x=2, y=33)
                self.campo_busca = CTkEntry(
                    self.frame_guarda_notas,
                    width=162,
                    corner_radius=10,
                    border_color=cbp,
                ...
                for lnb in lista_nota_buscar:
                    ...
                    label_titulo = CTkLabel(
                        frame_anotacao_b, text=titulo, text_color=ct
                    )
                    label_texto = CTkLabel(frame_anotacao_b, text=texto, text_color=ct)
                    if mtr != "Tipo De Notas...":  # Evita aparecer o nome setado
                        label_materia = CTkLabel(
                            frame_anotacao_b, text=mtr, corner_radius=15, text_color=ct
                        )
        ...
        def notas():
                ...
                if escolha == "Nota":
                    ...
                    def salvar_texto_codigo():
                        ...
                        if (
                            ...
                            self.erro_nota = CTkLabel(
                                self.frame_codigo,
                                text="Tamanho de descrição inválido (Min:3, Max:500)!!",
                                text_color="#E21010",
                                font=fonte_erros_inter,
                            )
                            self.erro_nota.place(x=245, y=30)
            ...
            def editar(evento):
                ...
                def muda_titulo_e(nota_escolha):
                    if nota_escolha == "Português":
                        self.entrada_titulo_e.configure(
                            placeholder_text="Gramática, literatura, redação..."
                        )
                        self.tipo_nota_e.configure(
                            fg_color="#FF8DA1",
                            button_color="#FF8DA1",
                            button_hover_color="#E67E91",
                        )
                ...
                def ler_e():
                    ...
                    def ler_titulo_e():
                        ...
                        if len(titulo_e) > 3 and len(texto_e) > 3 and pev == "Ativa":
                            ...
                            self.label_ative_voz_e = CTkLabel(
                                self.frame_anota,
                                text="Ative a Voz!",
                                text_color="#E21010",
                                font=fonte_erros_inter,
                    ...
                    self.thread_ler_titulo_e = threading.Thread(
                        target=ler_titulo_e, daemon=True
                    )
                ...
                self.tamanho_fonte_e = CTkOptionMenu(
                    self.frame_edita,
                    width=90,
                    cursor="hand2",
                    values=["8", "10", "12", "14", "16", "18", "20", "22"],
                    ...
                    dropdown_text_color=ctb,
                    dropdown_hover_color=ch,
                    command=fonte_tamanho_e,
                )
                self.entrada_titulo_e = CTkEntry(
                    self.frame_edita,
                    width=212,
                    corner_radius=10,
                    border_color=cbp,
                ...
                self.tipo_nota_e = CTkOptionMenu(
                    self.frame_edita,
                    width=90,
                    cursor="hand2",
                    values=[
                    ...
                    dropdown_text_color=ctb,
                    dropdown_hover_color=ch,
                    command=muda_titulo_e,
                )
                self.botao_deletar_e = CTkButton(
                    self.frame_edita,
                    text="Deletar",
                    fg_color=cls,
                    width=4,
                ...
                self.botao_leitura_e = CTkButton(
                    self.frame_edita,
                    text="Ler",
                    image=leitura,
                    fg_color=cls,
                ...
                if (
                    materia_frame == "Tipo De Notas..."
                    or materia_frame == "Outros Estudos"
                ):
            ...
            self.frame_notas = CTkScrollableFrame(
                self, width=440, height=330, fg_color=pg
            )
            self.frame_notas.place(x=20, y=0)
            self.frame_guarda_notas = CTkFrame(
            ...
            self.botao_cria_nota = CTkOptionMenu(
                ...
                dropdown_text_color=ctb,
                dropdown_hover_color=ch,
                command=escolha_comecar,
            )
            self.botao_cria_nota.set("Começar...")
            self.botao_cria_nota.place(x=2, y=33)
            self.campo_busca = CTkEntry(
                master=self.frame_guarda_notas,
                width=162,
                corner_radius=10,
                border_color=cbp,
                placeholder_text_color=cbp,
            ...
            for ln in self.lista_notas:
                ...
                if mtr != "Tipo De Notas...":  # Evita aparecer o nome setado
                    label_materia = CTkLabel(
                        frame_anotacao, text=mtr, corner_radius=15, text_color=ct
                    )
        ...
        def config():
            ...
            def cor_fundo(cor):
                if cor == "Noite":
                    ...
                    self.entrada_hexa.configure(
                        text_color="white",
                        placeholder_text="Digite a cor hexa...",
                        placeholder_text_color="#5E127F",
                        border_color="#5E127F",
                        fg_color="#101A12",
                    )
                    self.label_aviso_reinic.configure(text_color="white")
                    alerta = CTkImage(
                        Image.open(os.path.join(imagem_pasta, "alerta_preto.png")),
                        size=(17, 17),
                    )
                    self.alert.configure(image=alerta)
                    self.botao_voltar_config.configure(
                        fg_color="#5E127F", hover_color="#541070"
                    )
                    self.botao_enviar_hexa.configure(
                        fg_color="#5E127F", hover_color="#541070"
                    )
                    ...
                    self.cores_fundo.configure(
                        fg_color="#5E127F",
                        button_color="#5E127F",
                        button_hover_color="#541070",
                    )
                    ...
                    alerta = CTkImage(
                        Image.open(os.path.join(imagem_pasta, "alerta_branco.png")),
                        size=(17, 17),
                    )
                    self.alert.configure(image=alerta)
                    self.botao_voltar_config.configure(
                        fg_color="#105ba0", hover_color="#oc4478"
                    )
                    self.botao_enviar_hexa.configure(
                        fg_color="#105ba0", hover_color="#0c4478"
                    )
                    ...
                    alerta = CTkImage(
                        Image.open(os.path.join(imagem_pasta, "alerta_vermelho.png")),
                        size=(17, 17),
                    )
                    self.alert.configure(image=alerta)
                    self.botao_voltar_config.configure(
                        fg_color="#FFBFBF", hover_color="#F1B7B7"
                    )
                    self.botao_enviar_hexa.configure(
                        fg_color="#FFBFBF", hover_color="#F1B7B7"
                    )
                    ...
                    alerta = CTkImage(
                        Image.open(os.path.join(imagem_pasta, "alerta_azullogus.png")),
                        size=(17, 17),
                    )
                    self.alert.configure(image=alerta)
                    self.botao_voltar_config.configure(
                    ...
                    alerta = CTkImage(
                        Image.open(os.path.join(imagem_pasta, "alerta_amarelo.png")),
                        size=(17, 17),
                    )
                    self.alert.configure(image=alerta)
                    self.botao_voltar_config.configure(
                        fg_color="#FF5C00", hover_color="#EB5A05"
                    )
                    self.botao_enviar_hexa.configure(
                        fg_color="#FF5C00", hover_color="#EB5A05"
                    )
                    ...
                    self.botao_voltar_config.configure(
                        fg_color="#FC6C85", hover_color="#F26A81"
                    )
                    self.botao_enviar_hexa.configure(
                        fg_color="#FC6C85", hover_color="#F26A81"
                    )
                    alerta = CTkImage(
                        Image.open(os.path.join(imagem_pasta, "alerta_verde.png")),
                        size=(17, 17),
                    )
                    self.alert.configure(image=alerta)
                    ...
                    self.botao_voltar_config.configure(
                        fg_color="#1093D4", hover_color="#0c4478"
                    )
                    self.botao_enviar_hexa.configure(
                        fg_color="#1093D4", hover_color="#0c4478"
                    )
                    alerta = CTkImage(
                        Image.open(os.path.join(imagem_pasta, "alerta_azul.png")),
                        size=(17, 17),
                    )
                    self.alert.configure(image=alerta)
                    ...
                    self.botao_voltar_config.configure(
                        fg_color="#1093D4", hover_color="#D27D40"
                    )
                    self.botao_enviar_hexa.configure(
                        fg_color="#1093D4", hover_color="#D27D40"
                    )
                    alerta = CTkImage(
                        Image.open(os.path.join(imagem_pasta, "alerta_marrom.png")),
                        size=(17, 17),
                    )
                    self.alert.configure(image=alerta)
                    ...
                    alerta = CTkImage(
                        Image.open(os.path.join(imagem_pasta, "alerta_azulmn.png")),
                        size=(17, 17),
                    )
                    self.alert.configure(image=alerta)
                    self.label_config.configure(text_color="#105ba0")
                    ...
                    alerta = CTkImage(
                        Image.open(os.path.join(imagem_pasta, "alerta_padrao.png")),
                        size=(17, 17),
                    )
                    self.alert.configure(image=alerta)
            ...
            def valida_hexa():
                ...
                if len(num_hexa) > 7:
                    ...
                    self.erro_alpha_gradiente = CTkLabel(
                        self.frame_config,
                        text="Erro: Não suportamos valores Alpha!",
                        text_color="#E21010",
                        font=fonte_erros_inter,
                    )
                    ...
                    self.entrada_hexa.configure(border_color="red")
                    self.erro_tamanho = CTkLabel(
                        self.frame_config,
                        text="Erro: Valor pequeno demais!",
                        text_color="#E21010",
                        font=fonte_erros_inter,
                    )
                    self.label_voz.pack(pady=26)
                    ...
                    self.entrada_hexa.configure(border_color="red")
                    self.erro_hash = CTkLabel(
                        self.frame_config,
                        text="Erro: Verifique Se Tem Hashtag No Início!",
                        text_color="#E21010",
                        font=fonte_erros_inter,
                    )
                    self.label_voz.pack(pady=26)
            ...
            self.title("Sponte Study")
            self.frame_config = CTkScrollableFrame(
                self, width=440, height=310, fg_color=pg
            )
            self.frame_config.place(x=14, y=8)

            self.label_config = CTkLabel(
                self.frame_config, text="Configurações", text_color=cls, font=fonte_hora
            )
            self.label_config.pack(pady=22)
            self.alert = CTkLabel(self.frame_config, image=alerta, text=None)
            self.alert.place(x=77, y=91)
            self.label_aviso_reinic = CTkLabel(
                self.frame_config,
                text="As mudanças serão aplicadas após\n você reiniciar o app.",
                font=fonte_erros_inter,
                text_color=ct,
            )
            self.label_aviso_reinic.pack(pady=5)
            self.cores_fundo = CTkOptionMenu(
                self.frame_config,
                values=[
                    "Padrão",
                    "Noite",
            ...
            self.botao_enviar_hexa = CTkButton(
                self.frame_config,
                text="Validar",
                text_color=ctb,
                fg_color=cls,
            ...
            self.botao_voltar_config = CTkButton(
                self.frame_config,
                text="Voltar",
                text_color=ctb,
                fg_color=cls,
                ...
                height=22,
                cursor="hand2",
                command=voltar_config,
                hover_color=ch,
            )
            self.botao_voltar_config.place(x=1, y=0)
            self.label_voz = CTkLabel(
                self.frame_config, text="Voz", font=fonte_hora, text_color=cls
            )
            self.label_voz.pack(pady=7)
            self.voz_ativa = CTkSwitch(
                self.frame_config,
                text="Ativa",
                cursor="hand2",
                variable=padrao,
            ...
            if pev == "Ativa":
                ...
                self.voz_ativa.configure(text="Desativada")
            self.creditos = CTkLabel(
                self.frame_config,
                text="Imagens de Freepik.",
                text_color=ct,
                font=fonte_ajuda,
            )
            self.creditos.pack(pady=2)
            self.link_creditos = CTkLabel(
                self.frame_config,
                text="Acesse: https://br.freepik.com/app",
                text_color=ct,
                font=fonte_14,
            )
        ...
        self.botao_configuracoes = CTkButton(
            self.frame_central,
            text="Config",
            text_color=ctb,
            width=30,
